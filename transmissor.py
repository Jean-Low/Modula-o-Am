...
class Noiszes: 
    ...
    def modularizar(self, signal, freq):
                audio = signal
                ...
                plt.plot(np.arange(1000)/1000, np.sin(2*math.pi*freq*np.arange(1000)/1000))
                plt.show()
    ...
    def main(self):
        ...
        while(True):
            ...
            if(choice == '1'):
                ...
                print("\nFiltrando com passa baixa")
                print("\nQual frequencia de corte?")
                while True:
                    try:
                        choice = int(input())
                        break
                ...
                audio = self.LPF(audio,choice,self.fs)
                maxAudio = max(audio)
                print(maxAudio)
                audio /= maxAudio
                ...
                print('modularizar em que frequencia:')
                while True:
                    try:
                        choice = int(input())
                        break
                        ...
                        print('Coloque uma frequencia valida')
                audio = self.modularizar(audio,choice)
                print("Modularizado")
            elif(choice == '7'):
                ...
                print("Reproduzindo")
                self.playSound(stream, wait = False, looping = True)
                print("Para parar aperte ENTER" )
                input()
                sd.stop()
